...
export default function Footer({ locale }: Props) {
  ...
  return (
    <footer className="bg-white border-t py-10 mt-14" style={{ borderTopColor: "var(--color-warm-200)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 pt-6 border-t text-center text-xs" style={{ borderTopColor: "var(--color-warm-100)", color: "var(--color-ink-400)" }}>
